...
An interactive Europe map. Click a country and get the **3–5 government policies** that make the
...
A **Compare** view puts the at-a-glance line (child cash, paid leave, childcare, tax relief) of all
countries side by side. Sister project of [Fight the Academic Bullies](https://fightacademicbullies.org).

Coverage: EU-27 + United Kingdom, Switzerland, Norway, Iceland (31 countries).

Six colour-coded categories:
...
```json
{
  ...
  "headline": {"cash": "…", "leave": "…", "childcare": "…", "tax": "…"},
  "policies": [
    {"rank": 1, "cat": "cash|leave|childcare|tax|housing|healthedu",
